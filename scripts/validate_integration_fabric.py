...
def validate() -> None:
    ...
    for adapter in registry["adapters"]:
        ...
        require(
            ...
            and repository.startswith(("appolon1908-hue/", "ingtrader21-spec/")),
            "integration fabric invariant failed: adapter repository owner must be an approved Codestra namespace",
        )
