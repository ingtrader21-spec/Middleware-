...
def build() -> tuple[dict[str, Any], str]:
    ...
    variable_names = {"base_url", "environment", "RUN_EFFECTFUL", "bearer_token", "db_read_token", "db_verify_token", "tenant_id", "correlation_id", "request_id", "test_syn"}
    ...
    defaults = {
        ...
        "db_verify_token": "",
        "tenant_id": "TEST_SYN",
        "correlation_id": "postman-local",
        "request_id": "postman-local",
        "test_syn": "TEST_SYN",
    }
    collection = {
        "info": {
